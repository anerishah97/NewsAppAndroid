...
public class PoliticsFragment extends Fragment {
    ...
    private String url = "https://nodejs-backend-new.wl.r.appspot.com/guardian-section?section=politics";
    ...
    public void makeHttpRequest(View rootView, int type){
        final LinearLayout linearLayout = rootView.findViewById(R.id.progress_custom_politics);
    ...
    public void setAdapter(List<NewsCardData> list){
        Log.d("politics sze of array ", list.size() + "");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview =  inflater.inflate(R.layout.fragment_politics, container, false);
        recyclerView = rootview.findViewById(R.id.list_rv_politics);
        mSwipeRefreshLayout = rootview.findViewById(R.id.politics_swiperefresh_items);
