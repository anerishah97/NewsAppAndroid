...
public class ScienceFragment extends Fragment {
    ...
    private String url = "https://nodejs-backend-new.wl.r.appspot.com/guardian-section?section=science";
    ...
    public void makeHttpRequest(final View rootView, int type){
        final LinearLayout linearLayout = rootView.findViewById(R.id.progress_custom_science);
    ...
    public void setAdapter(List<NewsCardData> list){
        Log.d("science sze of array ", list.size() + "");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = rootview.findViewById(R.id.list_rv_science);
        mSwipeRefreshLayout = rootview.findViewById(R.id.science_swiperefresh_items);
